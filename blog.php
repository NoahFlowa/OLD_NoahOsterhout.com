    ...
    <div class="col-md-10">
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          ...
          <p class="display-4 lead"><strong>Not Just Another <span style="color: #22c2fc;">B</span>log</strong></p>
        </div>
      </div>

      <p class="display-4 lead" style="text-align: center;">nothing to see here, move along, move along</p>
